...
class opts():
    ...
    def init(self):
        ...
        self.parser.add_argument('--root_path', type=str, default='/media/zju/data1/zzy_data/PoseDataset/')
        ...
        self.parser.add_argument('--gpu', default='1,2,3', type=str, help='')
        ...
        self.parser.add_argument('--backbone', type=str, default='conv')
        
        
        self.parser.add_argument('--n_joints', type=int, default=16)
        self.parser.add_argument('--out_joints', type=int, default=16)
        ...
        self.parser.add_argument('--third_path',type=int,default=0)
    ...
    def parse(self):
        ...
        if self.opt.MAE:
            ...
            st = 'finetune_'+ self.opt.backbone+'_'

        self.opt.checkpoint = '/media/zju/data1/zzy_data/ori/'+ st+self.opt.name+ '_f%d'%(self.opt.pad*2+1) + '_t%.2f'%(self.opt.temporal_mask_rate)
